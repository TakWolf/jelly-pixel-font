...
def make_preview_image(font_size: FontSize):
    ...
    _draw_text(image, (font_size, font_size), '果冻像素字体 / Jelly Pixel Font', font_zh_cn)
...
def make_github_banner(design_contexts: dict[FontSize, DesignContext]):
    ...
    _draw_text(image, (image.width / 2, 54 + line_height * 3), '★ 开源的泛拉丁与泛中日韩像素字体，圆体风格 ★', font_zh_cn, text_color=text_color, shadow_color=shadow_color, is_horizontal_centered=True)
...
def make_afdian_cover():
    ...
    _draw_text(image, (image.width / 2, 36 + line_height * 3), '★ 开源的泛拉丁与泛中日韩像素字体，圆体风格 ★', font_zh_cn, text_color=text_color, shadow_color=shadow_color, is_horizontal_centered=True)
