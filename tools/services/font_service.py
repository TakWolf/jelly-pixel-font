...
class FontBuildContext:
    ...
    def _create_builder(self, width_mode: WidthMode, language_flavor: LanguageFlavor) -> FontBuilder:
        ...
        builder.meta_info.family_name = f'Jelly Pixel {self.font_size}px {width_mode[:4].capitalize()} {configs.LANGUAGE_FLAVOR_TO_FONT_NAME[language_flavor]}'
        ...
        builder.meta_info.description = 'Open-source Pan-Latin and Pan-CJK pixel font in a rounded sans-serif style'
        builder.meta_info.copyright_info = 'Copyright (c) 2026, TakWolf (https://takwolf.com)'
        builder.meta_info.license_info = 'This Font Software is licensed under the SIL Open Font License, Version 1.1'
        builder.meta_info.vendor_url = 'https://jelly-pixel-font.takwolf.com'
        builder.meta_info.designer_url = 'https://takwolf.com'
        builder.meta_info.license_url = 'https://github.com/TakWolf/jelly-pixel-font/blob/master/LICENSE-OFL'
        ...
        if len(font_formats) > 0:
            for language_flavor in options.LANGUAGE_FLAVORS:
                ...
                for font_format in font_formats:
                    file_path = path_define.OUTPUTS_DIR.joinpath(f'jelly-pixel-{self.font_size}px-{width_mode}-{language_flavor}.{font_format}')
