...
class DesignContext:
    ...
    def _create_builder(self, width_mode: WidthMode, language_flavor: LanguageFlavor) -> FontBuilder:
        ...
        builder.meta_info.family_name = f'Jelly Pixel {self.font_size}px {width_mode[:4].capitalize()} {language_flavor}'
        ...
        builder.meta_info.copyright_info = 'Copyright (c) 2026, TakWolf (https://takwolf.com), with Reserved Font Name "Jelly Pixel"'
